...
void OverviewPage::updateHiveSummary()
{
    if (walletModel && walletModel->getHiveTableModel()) {
        ...
        ui->rewardsPaidLabel->setText(
            BitcoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rewardsPaid) + " " + BitcoinUnits::shortName(walletModel->getOptionsModel()->getDisplayUnit()));
        ui->costLabel->setText(
            BitcoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), cost) + " " + BitcoinUnits::shortName(walletModel->getOptionsModel()->getDisplayUnit()));
        ui->profitLabel->setText(
            BitcoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), profit) + " " + BitcoinUnits::shortName(walletModel->getOptionsModel()->getDisplayUnit()));
