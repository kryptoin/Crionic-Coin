...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Crionic address (e.g. %1)").arg(QString::fromStdString(DummyAddress(Params()))));
#endif
...
{
    if(uri.startsWith("crionic:

    {
        uri.replace(0, 15, "crionic:");    
