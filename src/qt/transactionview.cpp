                                                                                        ...
                                                                                        transactionView(0), abandonAction(0), bumpFeeAction(0), columnResizingFixer(0)
{
    ...
    typeWidget->addItem(tr("Hive bee creation"), TransactionFilterProxy::TYPE(TransactionRecord::HiveBeeCreation));

    typeWidget->addItem(tr("Hive community fund"), TransactionFilterProxy::TYPE(TransactionRecord::HiveCommunityFund));

    typeWidget->addItem(tr("Hivemined honey"), TransactionFilterProxy::TYPE(TransactionRecord::HiveHoney));
