...
public:
    ...
    void getBCTs(std::vector<CBeeCreationTransactionInfo>& vBeeCreationTransactions, bool includeDeadBees);

    bool createBees(int beeCount, bool communityContrib, QWidget* parent, double beePopIndex);
