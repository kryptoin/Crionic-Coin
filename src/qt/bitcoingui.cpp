                                                                                                                 ...
                                                                                                                 platformStyle(_platformStyle)
{
    ...
    QString windowTitle = tr("Crionic Coin - ");
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About Crionic Coin"), this);
...
{
    QString strTitle = tr("Crionic Coin");
