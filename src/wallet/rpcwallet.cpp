...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("setaccount", "\"LEr4hNAefWYhBMgxCFP2Po1NPrUeiK8kM2\" \"tabby\"") + HelpExampleRpc("setaccount", "\"LEr4hNAefWYhBMgxCFP2Po1NPrUeiK8kM2\", \"tabby\""));
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("getaccount", "\"LEr4hNAefWYhBMgxCFP2Po1NPrUeiK8kM2\"") + HelpExampleRpc("getaccount", "\"LEr4hNAefWYhBMgxCFP2Po1NPrUeiK8kM2\""));
...
UniValue createbees(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "\"txid\"                    (string) The transaction id.\n"
            "\nExamples:\n" +
            HelpExampleCli("createbees", "1") + HelpExampleCli("createbees", "5 true \"Cfkv9pniUJ2UoWvaukgD5Ksqx5EsVLzsCk\"") + HelpExampleRpc("createbees", "12") + HelpExampleRpc("createbees", "34 false \"Cfkv9pniUJ2UoWvaukgD5Ksqx5EsVLzsCk\""));
...
UniValue getnetworkhiveinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "  honey_pot,                      (numeric) Total potential network rewards available during bee lifespan (in " +
            CURRENCY_UNIT + ")\n"
                            ...
                            "}\n"
                            "\nExamples:\n" +
            HelpExampleCli("getnetworkhiveinfo", "") + HelpExampleRpc("getnetworkhiveinfo", ""));
...
UniValue gethiveinfo(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "        bee_fee_paid,             (numeric) Total bee creation fees (in " +
            CURRENCY_UNIT + ")\n"
            ...
            CURRENCY_UNIT + ")\n"
                            "            rewards_paid,         (numeric) The amount of block rewards earned by the bees (in " +
            CURRENCY_UNIT + ")\n"
                            "            profit,               (numeric) The profit earned by the bees (in " +
            CURRENCY_UNIT + ")\n"
                            ...
                            "}\n"
                            "\nExamples:\n" +
            HelpExampleCli("gethiveinfo", "") + HelpExampleCli("gethiveinfo", "true") + HelpExampleRpc("gethiveinfo", "false, 10"));
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            HelpRequiringPassphrase(pwallet) + "\n"
                                               ...
                                               "    {\n"
                                               "      \"address\":amount   (numeric or string) The crionic address is the key, the numeric amount (can be string) in " +
...
static const CRPCCommand commands[] =
    {
        ...
        {"wallet", "createbees", &createbees, {"bee_count", "community_contrib", "honey_address"}},

        {"wallet", "gethiveinfo", &gethiveinfo, {"include_dead", "min_honey_confirms"}},
